...
public:
  ...
  // And Apple doesn't care, and Xcode thinks the Latin-1 chars are unicode, and barfs on them.
#ifndef __APPLE__
  ...
  char operator[] (unsigned long at_index) const;
...
protected:
  char *theBuffer;
  unsigned long max;   // Total max buffer size including \0
  unsigned long used;  // Length not including \0
};

...
const Timestamp Graph::beginningOfTime = Timestamp(Year::Year(Global::dialogFirstYear + 1));
// Dec 31st, dialogLastYear
const Timestamp Graph::endOfTime = Timestamp(Year::Year(Global::dialogLastYear) + 1) - Global::day;

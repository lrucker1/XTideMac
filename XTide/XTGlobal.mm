...
// ObjectiveC is such a special case that this is a major rewrite of
// Global.cc
...
// Not sure why it's 1902, because the tide blending tries to use 1901 and fails.
...
const Timestamp Global::beginningOfTime = Timestamp(Year::Year(Global::dialogFirstYear + 1));
// Dec 31st, dialogLastYear
const Timestamp Global::endOfTime = Timestamp(Year::Year(Global::dialogLastYear) + 1) - Global::day;

XTSettings Global::settings;
Dstr Global::codeset;
...
{
  version_out = [[[NSFileManager defaultManager]
                  displayNameAtPath:[[NSBundle mainBundle] bundlePath]] UTF8String];
#ifdef NDEBUG
  version_out += " NDEBUG";
#endif

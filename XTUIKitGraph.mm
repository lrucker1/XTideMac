...
)
{
    ...
    UIBezierPath *tidePath = [UIBezierPath bezierPath];
    CGPoint p1;
    ...
    for (int x=0; x<(int)_xSize; ++x) {
        ...
        if (c != lastcolor) {
            if (lastcolor >= 0) {
                ...
                [tidePath addLineToPoint:p1];
                [tidePath addLineToPoint:CGPointMake(x+1, ybase)];
    ...
    [[mycolors[lastcolor] colorWithAlphaComponent:opacity] set];
    [tidePath addLineToPoint:CGPointMake(_xSize, ybase)];
    fill ? [tidePath fill] : [tidePath stroke];
}
                              ...
                              double opacity)
{
    ...
    [UIBezierPath strokeLineFromPoint:p1 toPoint:p2];
}
...
{
    [mycolors[c] set];
    [UIBezierPath strokeLineFromPoint:CGPointMake(xlo, y)
...
CocoaGraph::setPixel (int x, int y, Colors::Colorchoice c)
{
    ...
    [mycolors[c] set];
    [UIBezierPath strokeLineFromPoint:p1 toPoint:p1];
}
